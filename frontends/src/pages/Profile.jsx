  ...
  return (
    <div className="font-poppins px-8 py-8 min-h-screen bg-white">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-5 pt-10">
            ...
            <div className="space-y-1">
              <h3 className="text-xl font-medium text-black">Archit Anant</h3>
              <p className="text-sm text-gray-600">ari_archit_</p>
              <p className="text-sm text-gray-700">User <span className="font-medium">Votes Left : 8</span></p>
            </div>
          </div>
        </div>

        <div className="flex flex-col gap-4 items-start md:items-end" style={{ position: 'absolute', top: 50, right: 0, width: 180, height: 48, opacity: 1, zIndex: 2 , left: 846}}>
      ...
      <div className="flex gap-6 mb-8 text-sm">
        <button className="font-medium text-black border-b-2 border-black pb-1">Uploaded</button>
